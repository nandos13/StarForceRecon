...
/////// Diffuse:
                ...
                float4 _oclussion_var = tex2D(_oclussion,TRANSFORM_TEX(i.uv0, _oclussion));
                indirectDiffuse *= lerp(_oclussion_var.r,_oclussion_var.g,_oclussion_var.b); // Diffuse AO
